...
3. 显示模块：分为对所有人和私聊两部分。在聊天窗口中看到随时更新的聊天信息；用户可以给所有人或某一个聊天用户发送公共的聊天信息，可以给自己的聊天信息定义不用的颜色，还可以加上丰富的表情语言，这个聊天内容大家都会看到. 用户还可以给某个用户发送私人的聊天信息，这种信息属于私聊信息，只有发送者和接收者自己可以看到；
4. 人员列表：显示所有聊天人员名称，可以提供自动和手工刷新人员列表的功能。
